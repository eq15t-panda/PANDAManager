...
class OC3:
    def __init__(self, port):
        ...
        def read(self):
            ...
            """
            raw = self.ser.read(512)  # Read up to 512 bytes
            clean = raw.lstrip(b"\x01").strip()  # Remove leading 0x01 and trailing whitespace
            return clean.decode()  # Decode bytes to string
